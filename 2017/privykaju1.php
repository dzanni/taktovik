...
$query ="SELECT * FROM list WHERE link='https://youtu.be/sY7keRjGJqY'";
...
<br>
<br>
N.B. Куплет - логаэд с переменной анакрузой 1-2. Это официальный клип, до него выходило
<a href='http://www.taktovik.ru/2017/privykaju.php'>Mood video</a>. Композиция
была <a href='https://youtu.be/v8s5Uh47XbM'
target='_blank'>обвинена в плагиате</a> - заимствовании мелодии
 и манеры исполнения хита певицы Ханны  <a href='https://youtu.be/BCxyGcygaPU'
